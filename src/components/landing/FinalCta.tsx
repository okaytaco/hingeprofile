    ...
    <section className="relative overflow-hidden px-6 py-24 sm:px-10 lg:py-32">
      <div className="mx-auto max-w-6xl">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[2rem] sm:rounded-[3rem] border-3 sm:border-4 border-ink bg-[#C6FF4D] p-6 text-ink shadow-[10px_10px_0px_#0c0b09] sm:p-14 sm:shadow-[16px_16px_0px_#0c0b09] md:p-20"
        >
          ...
          <div className="relative z-10 mb-6 sm:mb-8 flex flex-wrap items-center justify-between gap-4">
            <div className="inline-flex items-center gap-2 rounded-full border-2 border-ink bg-surface px-3 sm:px-4 py-1 sm:py-1.5 font-display text-[10px] sm:text-xs font-black uppercase tracking-widest text-ink shadow-[3px_3px_0px_#0c0b09]">
          ...
          <div className="relative z-10 max-w-4xl">
            <h2 className="font-display text-2xl font-black uppercase leading-[1.05] tracking-tight text-ink sm:text-4xl md:text-6xl lg:text-7xl">
              Bored of a profile that sounds like{' '}
              <span className="inline-block rotate-1 rounded-xl sm:rounded-2xl border-3 sm:border-4 border-ink bg-surface px-3 py-1 sm:px-5 text-ink shadow-[4px_4px_0px_#0c0b09] sm:shadow-[6px_6px_0px_#0c0b09]">
                everyone else&apos;s?
              </span>
            </h2>
            <p className="mt-4 sm:mt-6 max-w-2xl font-sans text-sm font-bold text-ink/80 sm:text-lg md:text-2xl">
