...
/* ─── SVG sub-components (extracted for readability) ─── */

function SpeechBubbleSvg({ className }: { className?: string }) {
  return (
    <svg
      width="512"
      height="512"
...
function AiInterviewCard() {
  return (
    <svg viewBox="0 0 420 340" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-auto w-full drop-shadow-[5px_5px_0px_#0c0b09] hover:drop-shadow-[10px_10px_0px_#0c0b09] transition-all">
      ...
      <text x="34" y="44" fontFamily="Inter, sans-serif" fontSize="18" fontWeight="700" fill="#74C53A">AI Interview</text>
      ...
      <text x="52" y="96" fontFamily="Inter, sans-serif" fontSize="15" fontWeight="600" fill="#111">What&apos;s your</text>
      <text x="52" y="118" fontFamily="Inter, sans-serif" fontSize="15" fontWeight="600" fill="#111">ideal weekend?</text>
      <text x="176" y="136" fontFamily="Inter, sans-serif" fontSize="11" fontWeight="700" fill="#777">10:42 AM</text>
      <rect x="142" y="182" width="238" height="94" rx="18" fill="#DDFD8B" stroke="#0c0b09" strokeWidth="2" />
      <text x="160" y="214" fontFamily="Inter, sans-serif" fontSize="15" fontWeight="600" fill="#111">Coffee.</text>
      <text x="160" y="236" fontFamily="Inter, sans-serif" fontSize="15" fontWeight="600" fill="#111">Bookstore.</text>
      <text x="160" y="258" fontFamily="Inter, sans-serif" fontSize="15" fontWeight="600" fill="#111">Late night drive.</text>
      <text x="300" y="264" fontFamily="Inter, sans-serif" fontSize="11" fontWeight="700" fill="#555">10:43 AM ✓✓</text>
    </svg>
  );
}
...
function GeneratedPromptCard() {
  return (
    <svg viewBox="0 0 420 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-auto w-full drop-shadow-[5px_5px_0px_#0c0b09] hover:drop-shadow-[10px_10px_0px_#0c0b09] transition-all">
      ...
      <text x="58" y="46" fontFamily="Inter, Arial, sans-serif" fontSize="15" fontWeight="700" fill="#111111">Generated Prompt</text>
      ...
      <text x="34" y="95" fontFamily="Inter, Arial, sans-serif" fontSize="14" fontWeight="600" fill="#33">We&apos;ll get along if...</text>
      <rect x="34" y="112" width="320" height="110" rx="22" fill="#F6F6F6" stroke="#0c0b09" strokeWidth="2" />
      <text x="54" y="150" fontFamily="Inter, Arial, sans-serif" fontSize="24" fontWeight="800" fill="#111">you think terrible</text>
      <text x="54" y="182" fontFamily="Inter, Arial, sans-serif" fontSize="24" fontWeight="800" fill="#111">puns deserve</text>
      <text x="54" y="214" fontFamily="Inter, Arial, sans-serif" fontSize="24" fontWeight="800" fill="#111">a second chance.</text>
      <path
...
function PersonalityCard() {
  return (
    <svg viewBox="0 0 420 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-auto w-full drop-shadow-[5px_5px_0px_#0c0b09] hover:drop-shadow-[10px_10px_0px_#0c0b09] transition-all">
      ...
      <text x="56" y="47" fontFamily="Arial" fontSize="15" fontWeight="800" fill="#111">Personality</text>
      <circle cx="364" cy="40" r="3" fill="#0c0b09" />
      <circle cx="374" cy="40" r="3" fill="#0c0b09" />
      <circle cx="384" cy="40" r="3" fill="#0c0b09" />
      <line x1="34" y1="66" x2="364" y2="66" stroke="#0c0b09" strokeWidth="2" />
      <g fontFamily="Arial">
        <text x="34" y="100" fontSize="15" fontWeight="800">Humor</text>
        <text x="345" y="100" textAnchor="end" fontSize="14" fontWeight="700" fill="#111">9.1</text>
        ...
        <text x="34" y="148" fontSize="15" fontWeight="800">Curiosity</text>
        <text x="345" y="148" textAnchor="end" fontSize="14" fontWeight="700" fill="#111">8.2</text>
        ...
        <text x="34" y="196" fontSize="15" fontWeight="800">Adventure</text>
        <text x="345" y="196" textAnchor="end" fontSize="14" fontWeight="700" fill="#111">6.4</text>
        ...
        <text x="34" y="244" fontSize="15" fontWeight="800">Thoughtfulness</text>
        <text x="345" y="244" textAnchor="end" fontSize="14" fontWeight="700" fill="#111">8.8</text>
        ...
        <text x="34" y="294" fontSize="12" fontWeight="600" fill="#555">Generated after interview</text>
      </g>
    </svg>
  );
}
...
function ConfidenceScoreCard() {
  return (
    <svg viewBox="0 0 320 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-auto w-full drop-shadow-[5px_5px_0px_#0c0b09] hover:drop-shadow-[10px_10px_0px_#0c0b09] transition-all">
      ...
      <text x="54" y="47" fontFamily="Inter" fontSize="15" fontWeight="800" fill="#111">Confidence Score</text>
      ...
      <circle cx="160" cy="165" r="68" stroke="#C8FF4D" strokeWidth="16" strokeLinecap="round" strokeDasharray="427" strokeDashoffset="38" transform="rotate(-90 160 165)" />
      <circle cx="160" cy="165" r="60" stroke="#0c0b09" strokeWidth="2" fill="none" opacity="0.1" />
      <text x="160" y="160" textAnchor="middle" fontFamily="Inter" fontSize="50" fontWeight="800" fill="#111">91</text>
      <text x="160" y="186" textAnchor="middle" fontFamily="Inter" fontSize="15" fontWeight="600" fill="#555">Confidence</text>
    </svg>
  );
}
...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative overflow-hidden px-3 pt-28 pb-16 sm:pb-28 sm:pt-36 lg:px-4">
      ...
      <div className="relative z-10 grid max-w-none gap-8 sm:gap-12 lg:grid-cols-2 lg:items-start">
        {/* Left: headline + tagline */}
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: 'easeOut' }}>
          {/* Neo-brutalist tag pill */}
          <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 border-2 border-ink bg-highlight px-3 py-1 sm:px-3.5 sm:py-1.5 font-display text-[10px] sm:text-xs font-bold uppercase tracking-widest text-ink shadow-brutal-sm">
            <span className="h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-ink" />
            AI Profile Engine v1.0
          </div>

          <h1 className="font-display text-[18vw] font-extrabold leading-[0.90] tracking-tight text-ink sm:text-[14vw] lg:text-[9vw]">
            Hinge-
            <br />
            Profiler
          </h1>

          <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row sm:items-center sm:gap-6 md:gap-8 lg:mt-12 lg:gap-10">
            {/* Left side: eyes icon + Less Forms / More Conversations */}
            <div className="shrink-0">
              {/* eyes icon */}
              <div className="mb-4 sm:mb-6 h-8 w-10 sm:h-10 sm:w-12 transition-transform duration-300 hover:scale-110" data-slot="icon-eyes">
              ...
              <p className="font-display text-xl font-extrabold uppercase leading-[1.05] text-ink sm:text-4xl">
                Less
                <br />
                Forms.
              </p>
              <p className="mt-3 sm:mt-4 font-display text-2xl font-extrabold uppercase leading-[1.1] text-ink sm:text-4xl">
                More
                <br />
                <span className="mt-1 inline-block border-2 border-ink bg-[#C6FF4D] px-2 py-0.5 shadow-brutal-sm sm:px-2.5">
                  Conversations.
                </span>
              </p>
            </div>
            ...
            {!isMobile && (
              <div className="mt-8 flex items-center justify-center sm:mt-0 sm:justify-start translate-x-15 -translate-y-30" data-slot="graphic-speech-bubble">
                <SpeechBubbleSvg className="h-64 w-64 sm:h-80 sm:w-80 md:h-96 md:w-96 lg:h-[550px] lg:w-[550px] xl:h-[550px] xl:w-[550px] filter drop-shadow-[8px_8px_0px_#0c0b09] transition-all duration-300 hover:-translate-x-1.5 hover:-translate-y-1.5 hover:drop-shadow-[14px_14px_0px_#0c0b09]" />
              </div>
            )}

            {/* Mobile-only: smaller speech bubble inline */}
            {isMobile && (
              <div className="mt-6 flex justify-center" data-slot="graphic-speech-bubble-mobile">
                <SpeechBubbleSvg className="h-32 w-32 filter drop-shadow-[4px_4px_0px_#0c0b09]" />
              </div>
            )}
          </div>
        </motion.div>

        {/* Right: collage of interview/profile cards */}
        {isMobile ? (
          /* ─── Mobile: horizontal-scroll snap carousel ─── */
          <div className="w-full overflow-x-auto snap-x-mandatory no-scrollbar -mx-3 px-3">
            <div className="flex w-max gap-4 pb-4">
              {[
                { key: 'ai-interview', card: <AiInterviewCard />, rotate: '-rotate-2' },
                { key: 'generated-prompt', card: <GeneratedPromptCard />, rotate: 'rotate-1' },
                { key: 'personality', card: <PersonalityCard />, rotate: '-rotate-1' },
                { key: 'confidence', card: <ConfidenceScoreCard />, rotate: 'rotate-2' },
              ].map((item, i) => (
                <motion.div
                  key={item.key}
                  ...
                  className={`snap-start w-[280px] shrink-0 ${item.rotate}`}
                >
                  {item.card}
                </motion.div>
              ))}
          ...
          /* ─── Desktop: absolute-positioned overlapping collage ─── */
